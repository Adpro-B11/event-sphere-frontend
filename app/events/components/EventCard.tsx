...
export const EventCard: React.FC<EventCardProps> = ({ event }) => {
  ...
  // Quick-and-dirty: fallback pakai username dari context jika backend belum set organizer
  const organizerName = event.organizer || user?.username || "—";
    ...
    <div className="border rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
      <div className="p-5">
        ...
        <div className="mt-4 flex justify-between items-center">
          ...
          {/* Quick-and-dirty fallback organizer */}
          <p className="text-sm text-gray-500">By: {organizerName}</p>
        </div>
      </div>
    </div>
  );
